...
import { Search, FileText, Download, Eye, TrendingUp, Users, Activity, Calendar as CalendarIcon, Filter, BarChart3 } from "lucide-react";
  ...
  const reports = [
    {
      ...
      downloads: 89,
      size: "2.4 MB",
      description: "Comprehensive analysis of system usage patterns and user behavior across all modules",
      metrics: {
        users: 1247,
        prescriptions: 8934,
        facilities: 156
    ...
    },
    {
      ...
      downloads: 156,
      size: "1.8 MB",
      description: "Monthly breakdown of user activities, login patterns, and feature utilization",
      metrics: {
        users: 894,
        sessions: 12456,
    ...
    },
    {
      ...
      downloads: 67,
      size: "4.1 MB",
      description: "Monthly security assessment including threat analysis and vulnerability reports",
      metrics: {
        threats: 3,
        vulnerabilities: 1,
        incidents: 0
    ...
    },
    {
      ...
      downloads: 0,
      size: "1.9 MB",
      description: "Quarterly financial analysis including subscription revenue and operational costs",
      metrics: {
        revenue: "KES 2.4M",
        costs: "KES 1.8M",
        profit: "KES 600K"
  ...
  return (
    <div className="min-h-screen bg-background p-6 space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold text-gradient">System Reports</h1>
          ...
          <div className="grid gap-6">
            <Card className="healthcare-card">
              <CardHeader>
                ...
                <CardDescription>
                  Live system metrics and usage statistics
                </CardDescription>
              </CardHeader>
              <CardContent>
