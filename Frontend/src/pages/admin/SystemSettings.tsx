...
import { Settings, Shield, Database, Mail, Bell, Globe, Key, Save, RotateCcw, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background p-6 space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold text-gradient">System Settings</h1>
